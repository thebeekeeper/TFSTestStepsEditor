...
namespace TFSTestStepsEditor.TestStepsEditor_VsExtension
{
    ...
    /// </summary>
    [Guid(GuidList.guidTestStepsEditor_VsExtensionEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private TestStepsEditor_VsExtensionPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(TestStepsEditor_VsExtensionPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidTestStepsEditor_VsExtensionEditorFactory;
            pgrfCDW = 0;
